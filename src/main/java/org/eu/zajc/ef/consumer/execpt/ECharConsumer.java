 ...
 * for {@code char}. Unlike most other functional interfaces, {@link ECharConsumer}
 ...
 */
@FunctionalInterface
public interface ECharConsumer<E extends Throwable> extends CharConsumer {

	@Override
	default void accept(char p) {
		try {
			acceptChecked(p);
	...
	/**
	 * Same as {@link #accept(char)}, but throws a checked exception.
	 *
	 * @param p
	 *            the input argument
	 *
	 ...
	 */
	void acceptChecked(char p) throws E;
