 ...
 * {@code long}-producing primitive specialization of {@link ESupplier}.
 *
 * <p>
...
public interface ELongSupplier<E extends Throwable> extends LongSupplier {
	 ...
	 */
	long getCheckedAsLong() throws E;
	 ...
	 *             the defined exception type
	 *
	 * @deprecated Since 1.5, for removal. Use {@link #getCheckedAsLong()} instead
	 */
	@Deprecated
	default long getChecked() throws E {
		return getCheckedAsLong();
	}
