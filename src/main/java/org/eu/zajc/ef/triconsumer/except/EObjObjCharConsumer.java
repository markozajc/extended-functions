...
import org.eu.zajc.ef.biconsumer.except.EObjCharConsumer;
 ...
 * {@link EObjObjCharConsumer} is expected to operate via side-effects.
 *
 * <p>
 ...
 * @see TriConsumer
 * @see ECharConsumer
 * @see EObjCharConsumer
 *
 * @author Marko Zajc
 */
@FunctionalInterface
public interface EObjObjCharConsumer<T, U, E extends Throwable> extends ObjObjCharConsumer<T, U> {

	@Override
	default void accept(T t, U u, char p) {
		try {
			acceptChecked(t, u, p);
	...
	/**
	 * Same as {@link #accept(Object, Object, char)}, but throws a checked exception.
	 *
	 * @param t
	 ...
	 */
	void acceptChecked(T t, U u, char p) throws E;
