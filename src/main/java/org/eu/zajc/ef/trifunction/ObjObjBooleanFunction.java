 ...
 * {@code (reference, reference, boolean)} specialization of {@link TriFunction}.
 *
 * <p>
 * This is a functional interface whose functional method is
 * {@link #apply(Object, Object, boolean)}.
 *
 * @param <T>
...
public interface ObjObjBooleanFunction<T, U, R> {
	 ...
	 */
	@Nonnull
	default <V> ObjObjBooleanFunction<T, U, V> andThen(@Nonnull Function<? super R, ? extends V> after) {
