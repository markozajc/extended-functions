...
public interface ObjObjBooleanPredicate<T, U> {
	 ...
	 */
	@Nonnull
	default ObjObjBooleanPredicate<T, U> and(@Nonnull ObjObjBooleanPredicate<? super T, ? super U> other) {
	 ...
	 */
	@Nonnull
	default ObjObjBooleanPredicate<T, U> negate() {
	 ...
	 */
	@Nonnull
	default ObjObjBooleanPredicate<T, U> or(@Nonnull ObjObjBooleanPredicate<? super T, ? super U> other) {
		Objects.requireNonNull(other);
		return (t, u, p) -> test(t, u, p) || other.test(t, u, p);
	}
