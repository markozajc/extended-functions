 ...
 * @author Marko Zajc
 */
public interface ObjObjCharPredicate<T, U> {
	 ...
	 */
	@Nonnull
	default ObjObjCharPredicate<T, U> and(@Nonnull ObjObjCharPredicate<? super T, ? super U> other) {
	 ...
	 */
	@Nonnull
	default ObjObjCharPredicate<T, U> negate() {
	 ...
	 */
	@Nonnull
	default ObjObjCharPredicate<T, U> or(@Nonnull ObjObjCharPredicate<? super T, ? super U> other) {
		Objects.requireNonNull(other);
		return (t, u, p) -> test(t, u, p) || other.test(t, u, p);
	}
