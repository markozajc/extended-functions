...
public interface ObjObjLongPredicate<T, U> {
	 ...
	 */
	@Nonnull
	default ObjObjLongPredicate<T, U> and(@Nonnull ObjObjLongPredicate<? super T, ? super U> other) {
	 ...
	 */
	@Nonnull
	default ObjObjLongPredicate<T, U> negate() {
	 ...
	 */
	@Nonnull
	default ObjObjLongPredicate<T, U> or(@Nonnull ObjObjLongPredicate<? super T, ? super U> other) {
		Objects.requireNonNull(other);
		return (t, u, p) -> test(t, u, p) || other.test(t, u, p);
	}
