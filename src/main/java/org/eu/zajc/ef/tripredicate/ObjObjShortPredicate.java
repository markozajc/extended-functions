...
public interface ObjObjShortPredicate<T, U> {
	 ...
	 */
	@Nonnull
	default ObjObjShortPredicate<T, U> and(@Nonnull ObjObjShortPredicate<? super T, ? super U> other) {
	 ...
	 */
	@Nonnull
	default ObjObjShortPredicate<T, U> negate() {
	 ...
	 */
	@Nonnull
	default ObjObjShortPredicate<T, U> or(@Nonnull ObjObjShortPredicate<? super T, ? super U> other) {
		Objects.requireNonNull(other);
		return (t, u, p) -> test(t, u, p) || other.test(t, u, p);
	}
